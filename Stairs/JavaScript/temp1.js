...
function drawWndTreadsMetal(par) {
    ...
    */
	...
	if (params.riserType == "есть") {
		...
		riser.position.y = -marshPar.h - params.treadThickness;
	...
	if (params.riserType == "есть") {
		var riserPar = {
			len: treadParams[3].treadWidth / Math.cos(treadParams[3].edgeAngle),
			width: par.h,
			thk: params.riserThickness,
			dxfArr: dxfPrimitivesArr,
			dxfBasePoint: dxfBasePoint,
...
function drawWndTreadsMono(par) {
    ...
    */
	...
	tread2.position.y = par.h - params.treadThickness;
...
//	tread3.rotation.y = -Math.PI;
	...
	tread3.position.y = par.h * 2 - params.treadThickness;
...
function drawWndTreadsTimber(par){
	...
	*/
	...
	if(params.riserType == "есть"){
		...
		riser2.position.z = riser.position.z + (treadParams[1].treadWidth - displacementZ) * turnFactor;
	...
	if(params.riserType == "есть"){
		...
		riser.position.z = tread2.position.z + (displacementZ * Math.tan(riserPar.ang) + treadParams[2].treadWidthX) * turnFactor;

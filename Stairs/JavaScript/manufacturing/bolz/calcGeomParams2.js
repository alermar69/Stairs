...
function calcStright() {
	...
	document.getElementById('rezultat').innerHTML =
		"<h3 class = 'raschet' onclick = 'recalculate()'>Результаты расчета</h3>" +
		"Ширина проступи b = " + b + " мм<br/>" +
		"Подъем ступени h = " + h + " мм<br/>" +
		"Шаг 2h + b = " + (2 * h + b) + " мм<br/>" +
		"Ширина ступени а =  " + a + " мм;<br/>" +
		"Ширина марша М =  " + params.M + " мм;<br/>" +
		"Количество ступеней = " + stairAmt + " шт.<br/>";
	document.getElementById('rezultat').innerHTML +=
	...
	if (platformTop != "площадка")
		document.getElementById('rezultat').innerHTML +=
			"Габарит G = " + G + "мм.<br/>";
	document.getElementById('rezultat').innerHTML +=
		"Угол наклона марша = " + stairAngle + "гр.<br/>" +
		"Длина проекции лестницы на пол staircaseLength = " + staircaseLength + "мм.<br/>";
	...
	var par = {
		...
		model: model,
		staircaseLength: staircaseLength,
		G: G,
	}
	return par;
} //end of calcStright()

...
function drawRailingSectionForge2(par) {
    ...
    if (parRacks.botFirst) {
        ...
        rackPar.drawing = { marshId: par.marshId, poleId: 0, group: 'forged_railing', elemType: 'rack', pos: copyPoint(pos), len: rackPar.len, key: par.key };
        ...
        rackPar.drawing = { marshId: par.marshId, poleId: 1, group: 'forged_railing', elemType: 'rack', pos: copyPoint(pos), len: rackPar.len, key: par.key };
        var rack = drawForgedFramePart2(rackPar).mesh;
        rack.position.x = pos.x;
        rack.position.y = pos.y;
        rack.position.z = railingPositionZ;
        ...
        polePar.drawing = { marshId: par.marshId, poleId: 0, group: 'forged_railing', elemType: 'pole', place: 'top', pos: copyPoint(pos), key: par.key, len: polePar.len, ang: polePar.poleAngle };
        ...
        polePar.dxfBasePoint = newPoint_xy(par.dxfBasePoint, pos.x, pos.y);
        polePar.drawing = { marshId: par.marshId, poleId: 0, group: 'forged_railing', elemType: 'pole', place: 'bot', pos: copyPoint(pos), key: par.key, len: polePar.len, ang: polePar.poleAngle };
        var pole = drawForgedFramePart2(polePar).mesh;
        pole.position.x = pos.x;
        pole.position.y = pos.y;
        pole.position.z = railingPositionZ;
        ...
        var balParams = {
            ...
            drawing: { marshId: par.marshId, poleId: 0, key: par.key },
				}
    ...
    if (parRacks.topLast) {
        ...
        rackPar.drawing = { marshId: par.marshId, poleId: 2, group: 'forged_railing', elemType: 'rack', pos: copyPoint(pos), len: rackPar.len, key: par.key };
        var rack = drawForgedFramePart2(rackPar).mesh;
        rack.position.x = pos.x;
        rack.position.y = pos.y;
        rack.position.z = railingPositionZ;
        ...
        polePar.dxfBasePoint = newPoint_xy(par.dxfBasePoint, pos.x, pos.y);
        polePar.drawing = { marshId: par.marshId, poleId: 2, group: 'forged_railing', elemType: 'pole', place: 'top', pos: copyPoint(pos), key: par.key, ang: polePar.poleAngle };
        var pole = drawForgedFramePart2(polePar).mesh;
        pole.position.x = pos.x;
        pole.position.y = pos.y;
        pole.position.z = railingPositionZ;
        ...
        polePar.dxfBasePoint = newPoint_xy(par.dxfBasePoint, pos.x, pos.y);
        polePar.drawing = { marshId: par.marshId, poleId: 2, group: 'forged_railing', elemType: 'pole', place: 'bot', pos: copyPoint(pos), key: par.key, ang: polePar.poleAngle };
        var pole = drawForgedFramePart2(polePar).mesh;
        pole.position.x = pos.x;
        pole.position.y = pos.y;
        pole.position.z = railingPositionZ;
        ...
        var balParams = {
            ...
            dxfBasePoint: par.dxfBasePoint,
            material: params.materials.metal,
            drawing: { marshId: par.marshId, poleId: 2, key: par.key },
				}
    ...
    if (parRacks.marshFirst) {
        ...
        if (!parRacks.botFirst) {
            ...
            if (params.calcType == 'mono') {
                ...
                rackPar.isFirst = true;
						...
						rackPar.drawing = { isTurnRack: rackPar.isTurnRack, marshId: par.marshId, poleId: 1, group: 'forged_railing', elemType: 'rack', pos: copyPoint(pos), len: rackPar.len, key: par.key };
        ...
        for (var i = 0; i < par.racks.length; i++) {
            if (par.racks[i].x > parRacks.marshFirst.x && par.racks[i].x < parRacks.marshLast.x) {
                ...
                shortRackPar.drawing = { marshId: par.marshId, poleId: 1, group: 'forged_railing', elemType: 'rack', pos: copyPoint(pos), len: shortRackPar.len, key: par.key };
        ...
        polePar.dxfBasePoint = newPoint_xy(par.dxfBasePoint, pos.x, pos.y);
        polePar.drawing = { marshId: par.marshId, poleId: 1, group: 'forged_railing', elemType: 'pole', place: 'top', pos: copyPoint(pos), key: par.key, ang: polePar.poleAngle };
        var pole = drawForgedFramePart2(polePar).mesh;
        pole.position.x = pos.x;
        pole.position.y = pos.y;
        pole.position.z = railingPositionZ;
        ...
        pos.y = parRacks.marshFirst.y - 90 + botPoleOffset + dyRackTop + rackAddLen;
				...
				polePar.place = 'bot';
        polePar.drawing = { marshId: par.marshId, group: 'forged_railing', poleId: 1, elemType: 'pole', place: 'bot', pos: copyPoint(pos), key: par.key, ang: polePar.poleAngle };
        var pole = drawForgedFramePart2(polePar).mesh;
        pole.position.x = pos.x;
        pole.position.y = pos.y;
        pole.position.z = railingPositionZ;
        ...
        var balParams = {
            ...
            dxfBasePoint: par.dxfBasePoint,
            material: params.materials.metal,
            drawing: { marshId: par.marshId, poleId: 1, key: par.key },
				}
        var balArr = drawForgedBanistersArr(balParams);
				balArr.position.z = railingPositionZ;
        forgedParts.add(balArr);
    ...
    if (parRacks.marsh1First) {
        ...
        rackPar.dxfBasePoint = newPoint_xy(par.dxfBasePoint, pos.x, pos.y);
				rackPar.drawing = {marshId: par.marshId, poleId: 3, group: 'forged_railing', elemType:'rack', pos: copyPoint(pos), len: rackPar.len, key: par.key};
				var rack = drawForgedFramePart2(rackPar).mesh;
        rack.position.x = pos.x;
        rack.position.y = pos.y;
        rack.position.z = railingPositionZ;
        ...
        for (var i = 0; i < par.racks.length; i++) {
            if (par.racks[i].x > parRacks.marsh1First.x && par.racks[i].x < parRacks.botFirst.x) {
                ...
                shortRackPar.len = 150 + deltaY;
								...
								shortRackPar.drawing = {marshId: par.marshId, poleId: 3, group: 'forged_railing', elemType:'rack', pos: copyPoint(pos), len: shortRackPar.len, key: par.key};
        ...
        polePar.dxfBasePoint = newPoint_xy(par.dxfBasePoint, pos.x, pos.y);
				polePar.drawing = {marshId: par.marshId, poleId: 3, group: 'forged_railing', elemType:'pole', place: 'top', pos: copyPoint(pos), key: par.key, ang:polePar.poleAngle};
        var pole = drawForgedFramePart2(polePar).mesh;
        pole.position.x = pos.x;
        pole.position.y = pos.y;
        pole.position.z = railingPositionZ;
        ...
        polePar.dxfBasePoint = newPoint_xy(par.dxfBasePoint, pos.x, pos.y);
				polePar.drawing = {marshId: par.marshId, poleId: 3, group: 'forged_railing', elemType:'pole', place: 'bot', pos: copyPoint(pos), key: par.key, ang:polePar.poleAngle};
        var pole = drawForgedFramePart2(polePar).mesh;
        pole.position.x = pos.x;
        pole.position.y = pos.y;
        pole.position.z = railingPositionZ;
        ...
        var balParams = {
            ...
            dxfBasePoint: par.dxfBasePoint,
            material: params.materials.metal,
						drawing: {marshId: par.marshId, poleId: 3, key: par.key},
        }
        var balArr = drawForgedBanistersArr(balParams);
        balArr.position.z = railingPositionZ;
        forgedParts.add(balArr);
    ...
    if (parRacks.marsh2First) {
        ...
        rackPar.dxfBasePoint = newPoint_xy(par.dxfBasePoint, pos.x, pos.y);
				rackPar.drawing = {marshId: par.marshId, poleId: 4, group: 'forged_railing', elemType:'rack', pos: copyPoint(pos), len: rackPar.len, key: par.key};
        var rack = drawForgedFramePart2(rackPar).mesh;
        rack.position.x = pos.x;
        rack.position.y = pos.y;
        rack.position.z = railingPositionZ;
        ...
        for (var i = 0; i < par.racks.length; i++) {
            if (par.racks[i].x > parRacks.marsh2First.x && par.racks[i].x < parRacks.marsh2Last.x) {
                ...
                pos.y = par.racks[i].y - 90;
                shortRackPar.dxfBasePoint = newPoint_xy(par.dxfBasePoint, pos.x, pos.y);
								shortRackPar.drawing = {marshId: par.marshId, poleId: 4, group: 'forged_railing', elemType:'rack', pos: copyPoint(pos), len: shortRackPar.len, key: par.key};
                //рассчитываем длину
        ...
        pos = newPoint_xy(topPoint4, 0, -20 / Math.cos(parRacks.angMarsh2))
				polePar.drawing = {marshId: par.marshId, poleId: 4, group: 'forged_railing', elemType:'pole', place: 'top', pos: copyPoint(pos), key: par.key, ang:polePar.poleAngle};
        polePar.dxfBasePoint = newPoint_xy(par.dxfBasePoint, pos.x, pos.y);
        var pole = drawForgedFramePart2(polePar).mesh;
        pole.position.x = pos.x;
        pole.position.y = pos.y;
        ...
        polePar.dxfBasePoint = newPoint_xy(par.dxfBasePoint, pos.x, pos.y);
				polePar.drawing = {marshId: par.marshId, poleId: 4, group: 'forged_railing', elemType:'pole', place: 'bot', pos: copyPoint(pos), key: par.key, ang:polePar.poleAngle};
        var pole = drawForgedFramePart2(polePar).mesh;
        pole.position.x = pos.x;
        pole.position.y = pos.y;
        pole.position.z = railingPositionZ;
        ...
        var balParams = {
            ...
            dxfBasePoint: par.dxfBasePoint,
            material: params.materials.metal,
						drawing: {marshId: par.marshId, poleId: 4, key: par.key},
        }
        var balArr = drawForgedBanistersArr(balParams);
        balArr.position.z = railingPositionZ;
        forgedParts.add(balArr);

...
//детили ограждений
	...
	if(stairAmt == 3) {
		list.handrail_marsh.name += " L=940мм";
		list.rigel_marsh.name += " L=740мм";		
		}
	if(stairAmt == 4) {
		list.handrail_marsh.name += " L=1260мм";
		list.rigel_marsh.name += " L=1060мм";		
		}
	if(stairAmt == 5) {
		list.handrail_marsh.name += " L=1580мм";
		list.rigel_marsh.name += " L=1380мм";		
		}
	if(stairAmt == 6) {
		list.handrail_marsh.name += " L=1900мм";
		list.rigel_marsh.name += " L=1700мм";		
		}
		
	if(params.topPltLength_stock == 600) {
		list.handrail_plt3.name += " L=380мм";
		list.rigel_plt3.name += " L=450мм";
		}
	if(params.topPltLength_stock == 900) {
		list.handrail_plt3.name += " L=680мм";
		list.rigel_plt3.name += " L=750мм";
		}
	...
	list.rackInox= {
		name: "Стойка нерж. 40х40 бок. крепление 950 мм 304", 
		amtName: "шт.",
		metalPaint: true,
		timberPaint: false,
		division: "stock_2",
	...
	list.rack_plt= {
		name: "Стойка краш. 1000мм. 40х40 бок. крепление",
		amtName: "шт.",
		metalPaint: true,
		timberPaint: false,
		division: "stock_2",
	...
	list.deckingTopPlt= {
		name: "Доска ДПК L=" + (params.platformWidth_3 - 22),
		amtName: "шт.",
		metalPaint: false,
		timberPaint: false,
		division: "timber",
	...
	list.deckingCutedMidPlt= {
		name: "Доска ДПК L=" + (params.M - 22) + " резаная по длине",
		amtName: "шт.",
		metalPaint: false,
		timberPaint: false,
		division: "timber",
	...
	list.deckingCutedTopPlt= {
		name: "Доска ДПК L=" + (params.platformWidth_3 - 22) + " резаная по длине",
		amtName: "шт.",
		metalPaint: false,
		timberPaint: false,
		division: "timber",
	...
	list.timberBoard= {
		name: "Доска лиственница L=" + (params.M - 22),
		amtName: "шт.",
		metalPaint: false,
		timberPaint: false,
		division: "timber",
	...
	list.timberBoardTopPlt= {
		name: "Доска лиственница L=" + (params.platformWidth_3 - 22),
		amtName: "шт.",
		metalPaint: false,
		timberPaint: false,
		division: "timber",
	...
	list.timberBoardCutedMidPlt= {
		name: "Доска лиственница L=" + (params.M - 22) + " резаная по длине",
		amtName: "шт.",
		metalPaint: false,
		timberPaint: false,
		division: "timber",

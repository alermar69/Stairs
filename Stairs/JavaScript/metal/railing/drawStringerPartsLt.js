...
function drawBotStepLt_floor(stringerParams, turnFramesParams, platformFramesParams, marshFramesParams) {
    ...
    if (stringerParams.railingPresence) {
        ...
        var offsetLeft = 200;
        var offsetTop = 100;
        addLeader(text, textHeight, offsetLeft, offsetTop, dxfPrimitivesArr, center1, stringerParams.dxfBasePoint)
        addLeader(text, textHeight, offsetLeft, offsetTop, dxfPrimitivesArr, center2, stringerParams.dxfBasePoint)
    }
...
function drawBotStepLt_wndOut(stringerParams, turnFramesParams, platformFramesParams, marshFramesParams, turnStepsParams) {
    ...
    if (stringerParams.stairFrame == "есть") {
		...
		if (stringerParams.stringerType != 'ломаная') {
			...
			var pstart = newPoint_xy(pc_3, stringerParams.rad1, 0.0);	
		}
    ...
    if (stringerParams.stairFrame == "нет") {
		...
		else var pstart = newPoint_xy(pc_3, stringerParams.rad1, 0.0);	
    ...
    if (stringerParams.railingPresence) {
        ...
        var offsetLeft = 200;
        var offsetTop = 100;
        if (center1 != 0) addLeader(text, textHeight, offsetLeft, offsetTop, dxfPrimitivesArr, center1, stringerParams.dxfBasePoint)
        if (center2 != 0) addLeader(text, textHeight, offsetLeft, offsetTop, dxfPrimitivesArr, center2, stringerParams.dxfBasePoint)
...
function drawTopStepLt_floor(stringerParams, turnFramesParams, platformFramesParams, marshFramesParams) {
    ...
    if (stringerParams.stringerType == "ломаная") {
		...
		p2 = newPoint_xy(p22, -stringerParams.b, 0.0);
		p2.x = stringerParams.pstart.x;
		addLine(stringerParams.stringerShape, dxfPrimitivesArr, newPoint_xy(p22, -stringerParams.rad1, 0.0), newPoint_xy(p2, stringerParams.rad2, 0.0), stringerParams.dxfBasePoint);
    ...
    if (stringerParams.stringerType != "ломаная") {
        ...
        if (fil1.end.x <= fil2.start.x) {
            var fil1 = fillet(botLineP1,
                Math.PI * 1.5,
                stringerParams.pstart,
                stringerParams.pstartang,
                stringerParams.rad1);
            ...
            addArc(stringerParams.stringerShape,
                ...
                fil1.angend,
                stringerParams.dxfBasePoint);
            addLine(stringerParams.stringerShape,
                dxfPrimitivesArr,
                fil1.end,
                stringerParams.pstart,
                stringerParams.dxfBasePoint);
            ...
            // низ
            if (key == "out") {
                stringerParams.pgalssPosition = polar(fil2.end,
                    fil2.angend - Math.PI * 1.5,
                    stringerParams
                    .rad1 *
                    Math.tan((fil2
                            .angstart -
                            fil2.angend) *
                        0.5)); // точка привязки стекла ограждения (самонесущее стекло)
            }
        ...
        if (stringerParams.botEnd == "winderBot0") {
            ...
            if (stringerParams.stairAmt == 0) {
                if ((stringerParams.marshDist - 75) >= stringerParams.rad1) {
                    ...
                    var p3 = newPoint_xy(p1,
                        0.0,
                        stringerParams.h -
                        stringerParams.rad1 +
                        topLineStringerProtrusion +
                        40 -
                        stringerParams.treadThickness);
                } else {
            ...
            addLine(stringerParams.stringerShape,
                dxfPrimitivesArr,
                p4,
                newPoint_xy(p2, -stringerParams.rad1, 0.0),
                stringerParams.dxfBasePoint);
            addArc(stringerParams.stringerShape,
                dxfPrimitivesArr,
                pc2,
            ...
            if (stringerParams.stringerType == "ломаная") {
                ...
                addLine(stringerParams.stringerShape,
                    dxfPrimitivesArr,
                    fil0.end,
                    newPoint_xy(p_3, stringerParams.rad2, 0.0),
                    stringerParams.dxfBasePoint);
                ...
                if (stringerParams.stairAmt != 0) {
                    ...
                    var fil2 = fillet(p20,
                        stringerParams.stairAngle1 + Math.PI,
                        stringerParams.pstart,
                        stringerParams.pstartang,
                        stringerParams.rad1);
                    addLine(stringerParams.stringerShape, dxfPrimitivesArr, p1, fil1.start, stringerParams.dxfBasePoint);
                    ...
                    alfa = Math.atan((pc1
                            .y -
                            stringerParams.pstart.y) /
                        (pc1.x - stringerParams.pstart.x)); // определяем угол наклона нижней линии тетивы
                    // задняя линия тетивы
                    addLine(stringerParams.stringerShape, dxfPrimitivesArr, p1, p2, stringerParams.dxfBasePoint);
                    addArc(stringerParams.stringerShape,
                        dxfPrimitivesArr,
            ...
            if (stringerParams.stairAmt > 1) {
                ...
                if (key == "out") {
                    stringerParams.pgalssPosition = polar(fil2.end,
                        ...
                        stringerParams
                        .rad1 *
                        Math.tan((fil2.angstart - fil2.angend) * 0.5)); // точка привязки стекла ограждения (самонесущее стекло)
                }
                // низ
                addLine(stringerParams.stringerShape, dxfPrimitivesArr, fil2.end, stringerParams.pstart, stringerParams.dxfBasePoint);
            }

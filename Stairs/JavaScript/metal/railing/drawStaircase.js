...
drawStaircase = function (viewportId, isVisible) {
        ...
        function drawStrightStringers() {
            ...
            if (platformTop == "площадка") {
                ...
                if (model == "лт") {
                    // задняя тетива площадки
                    p0 = {
                        x: b1 * stairAmt1 + params.platformLength_3 + 5.0,
        ...
        function drawStraightAngles() {
            ...
            if (platformTop != "площадка") {
                ...
                if (topFlan == "есть") {
                    ...
                    flan.position.z = flanParams.width + stringerThickness + stringerSideOffset;
                    ...
                    flan2.position.z = params.M - stringerThickness - stringerSideOffset;
                    flan2.rotation.x = 0;
    ...
    function drawGStaircase() {
        var extendTopTurnTread = 0.0;
        if (params.model == "ко") {
            if (params.floorHoleWidth < params.M + 120.0) {
                alert("Ширина проема А = " + params.floorHoleWidth + "мм - меньше чем M + 120мм (" + (params.M + 120.0) + "мм)\n" +
        		      "для КО по конструктивным соображениям невозможно спроектировать лестницу!\n\n" +
        		      "Измените ширину марша или проема.");
            }
            if (params.floorHoleWidth >= params.M + 120.0 && params.floorHoleWidth < params.M + 220.0) {
                if (params.stairAmt3 != 0) {
                    alert("Ширина проема А = " + params.floorHoleWidth + "мм - от M + 120мм до M + 240мм\n" +
						  "для КО в верхнем марше не должно быть ступеней.\n\n" +
        		    	  "Измените количество ступеней верхнего марша, ширину марша или проема.");
                }
                else {
                    extendTopTurnTread = params.floorHoleWidth - params.M - 72.0;
                }
            }
            if (params.floorHoleWidth >= params.M + 220.0 && params.floorHoleWidth < params.M + 420.0) {
                if (params.stairAmt3 != 1) {
                    alert("Ширина проема А = " + params.floorHoleWidth + "мм - от M + 220мм до M + 420мм\n" +
	        		      "для КО в верхнем марше должна быть только одна ступень.\n\n" +
	        		      "Измените количество ступеней верхнего марша, ширину марша или проема.");
                }
                else {
                    extendTopTurnTread = params.floorHoleWidth - params.M - 72.0 - params.b3;
                }
            }
            if (params.floorHoleWidth >= params.M + 420.0 && params.stairAmt3 === 0) {
                extendTopTurnTread = 40.0;
            }
        }

        var stepWidthLow = 40.0713;
        if (params.stairAmt3 == 0) stepWidthLow = 110;

        if (params.model == "лт") {
            if (params.floorHoleWidth < params.M + 110.0) {
                alert("Ширина проема А = " +
                    params.floorHoleWidth +
                    "мм - меньше чем M + 110мм\n" +
                    "для ЛТ по конструктивным соображениям невозможно спроектировать лестницу!\n\n" +
                    "Измените ширину марша или проема.");
            }
            if (params.floorHoleWidth >= params.M + 110.0 && params.floorHoleWidth < params.M + 200.0) {
                if (params.stairAmt3 != 0) {
                    alert("Ширина проема А = " +
                        params.floorHoleWidth +
                        "мм - от M + 120мм до M + 240мм\n" +
                        "для ЛТ в верхнем марше не должно быть ступеней.\n\n" +
                        "Измените количество ступеней верхнего марша, ширину марша или проема.");
                } else {
                    stepWidthLow = params.floorHoleWidth - params.M;
                }
            }
            if (params.floorHoleWidth >= params.M + 200.0 && params.floorHoleWidth < params.M + 400.0) {
                if (params.stairAmt3 != 1) {
                    alert("Ширина проема А = " +
                        params.floorHoleWidth +
                        "мм - от M + 220мм до M + 420мм\n" +
                        "для ЛТ в верхнем марше должна быть только одна ступень.\n\n" +
                        "Измените количество ступеней верхнего марша, ширину марша или проема.");
                } else {
                    stepWidthLow = params.floorHoleWidth - params.M - params.b3;
                }
            }
        }
        ...
        if (stringerTurn == "забег") {
            ...
            var turnParams = {
                ...
                turnFactor: turnFactor,
                dxfBasePoint: dxfBasePoint,
                extendTopTurnTread: extendTopTurnTread,
                stepWidthLow: stepWidthLow, // глубина 3 забежной ступени
            }
            ...
            dxfBasePoint = newPoint_xy(dxfBasePoint, M * 4 + 500, 0);
            ...
            if (turnModel == "лт стекло") {
                ...
                turnFramesParams = {
                    ...
                    stepWidthLow: stepWidthLow + 60, // глубина 3 забежной ступени
                };
        ...
        if (platformTop == "площадка") {
            //if (platformTop == "площадка" && params.stairAmt3 != 0) {
            if (stairType !== "рифленая сталь" && stairType !== "рифленый алюминий") {
                treadsMarsh3 = drawPlatformCover(platformCoverParams3, platformFramesParams3);
        ...
        function drawGStringers1() {
            ...
            if (params.model == "ко" && stairModel == "Г-образная с забегом") {
                ...
                if (stringerParams.stringerType == 'ломаная') stringerParams1.topEndLength = stringerSideOffset - 15 + stringerThickness + 60 + 5;
            }
            ...
            if (params.model == "лт" && stairModel == "Г-образная с забегом" && stairAmt1 === 0) {
                stringerParams1.botEnd = "winderBot0";
                stringerParams1.stairAmt = 0;
            }
            stringerParams1.key = "out";
            ...
            if (params.model == "лт") {
                if (params.stairAmt1 == 0 && stringerParams1.topEnd == "platformG" && stairModel != "Г-образная с забегом") drawStringerLt_0Bot_PltG(stringerParams1, turnFramesParams, undefined, platformFramesParams1, marshFramesParams1, turnParams);
                else drawStringerLt(stringerParams1, turnFramesParams, undefined, platformFramesParams1, marshFramesParams1, turnParams);
            }
            ...
            if (stringerTurn == "площадка") {
                ...
                if (model == "ко") {
                    ...
                    //задняя тетива площадки
                    p0 = {
                        x: b1 * stairAmt1 + a1 - b1 - 40.0 + tyrnLength - stringerSideOffset,
                        y: h1 * (stairAmt1 + 1) - treadThickness,
                        z: stringerSideOffset + stringerThickness
                    };
                ...
                if (params.model == "лт") {
                    // задняя тетива площадки
                    p0 = {
                        x: b1 * stairAmt1 + tyrnLength + 5.0 + stringerThickness,
                        y: h1 * (stairAmt1 + 1) + 5.0,
                        z: 0.0
                    };
        ...
        function drawGAngles1() {
            ...
            angleB.position.x = stringerParams1.elmIns["in"].angleB[0].x + 100.0;
            angleB.position.y = stringerParams1.elmIns["in"].angleB[0].y;
            ...
            angleB.castShadow = true;
            stringerParams1.groupang.add(angleB);
            if (params.stairAmt1 == 0 && stringerParams1.elmIns["out"].angleB[1]) {					// уголки крепления к полу (если в нижнем марше 0 ступеней)
                // внешеий
                var angleB = drawAngleSupport("У4-70х70х100");
                if (params.bottomAngleType === "регулируемая опора") {
                    angleB = drawAdjustableLeg();
                }
                angleB.position.x = stringerParams1.elmIns["out"].angleB[1].x;
                angleB.position.y = stringerParams1.elmIns["out"].angleB[1].y;
                angleB.position.z = stringerThickness + stringerSideOffset;
                angleB.rotation.x = 0.0;
                angleB.rotation.y = 0.0;
                angleB.rotation.z = 0.0;
                ...
                angleB.position.x = stringerParams1.elmIns["out"].angleB[1].x + 100.0;
                angleB.position.y = stringerParams1.elmIns["out"].angleB[1].y;
                angleB.position.z = (M - stringerThickness) - stringerSideOffset;
                angleB.rotation.x = 0.0;
                angleB.rotation.y = Math.PI;
            ...
            if (stairFrame == "нет") {
                if (params.model == "лт") {
                    ...
                    if (stringerTurn == "площадка") {
                        ...
                        angle1.position.x = p0.x + 76.0;
                        angle1.position.y = p0.y;
                        angle1.position.z = stringerThickness + 200.0 + 105.0;
                        ...
                        angle1.position.x = p0.x + 76.0;
                        angle1.position.y = p0.y;
                        angle1.position.z = stringerThickness + treadWidth - 95.0;
                        angle1.rotation.x = Math.PI * 0.5;
                        angle1.rotation.y = 0.0;
                        angle1.rotation.z = Math.PI * 1.5;
                        angle1.castShadow = true;
        ...
        if (stairFrame == "есть") {
            ...
            //if (platformTop == "площадка") {
            if (platformTop == "площадка" && (params.stairAmt3 != 0 || stairModel == "Г-образная с забегом")) {
                // Рамки верхней площадки
                platformFramesParams3 = {
                    M: params.M,
                    platformLength: platformLengthTop,
        ...
        stringerParams3 = {
            ...
            elmIns: {},// точки размещения уголков
            railingModel: railingModel, //модель ограждения
            bottomTrimm: stairAmt1 === 0, // подрезать снизу, если в нижнем марше нет ступеней
            extendTopTurnTread: extendTopTurnTread,
        };

        if (params.stairAmt3 != 0 || stairModel == "Г-образная с забегом") {
            drawGStringers3();
        }
        function drawGStringers3() {
            ...
            if (params.model == "лт" && stairModel == "Г-образная с забегом" && stairAmt3 === 0) {
                stringerParams3.botEnd = "winderTop0";
                stringerParams3.stairAmt = 1;
            }
            ...
            if (params.model == "лт") {
                if (params.stairAmt3 == 1 && platformTop != "площадка" && stairModel != "Г-образная с забегом") drawStringerLt_1Top_PltG(stringerParams3, turnFramesParams, platformFramesParams1, platformFramesParams3, marshFramesParams3, turnParams);
                else drawStringerLt(stringerParams3, turnFramesParams, platformFramesParams1, platformFramesParams3, marshFramesParams3, turnParams);
            }
        ...
        function drawGAngles3() {
            ...
            if (stringerTurn == "забег") {
                ...
                //уголки соединения внешних/внутренних тетив
                var angleB = drawAngleSupport("У4-60х60х100");
                ...
                if ((key1 == "out" || !stringerParams3.bottomTrimm) && stringerParams3.elmIns[key1].angleB[1]) {
                    var angleB = drawAngleSupport("У4-60х60х100");
                ...
                //уголки соединения внутренних/внешних тетив
                angleB = drawAngleSupport("У4-60х60х100");
                ...
                if (stringerParams3.elmIns[key2].angleB[1]) {
                    angleB = drawAngleSupport("У4-60х60х100");
            ...
            if (platformTop != "площадка") {
                ...
                if (topAnglePosition == "вертикальная рамка") {
                    ...
                    if (params.model == "лт") {
                        ...
                        if (stairAmt3 == 0)
                            complexUnit.position.x = stringerParams3.elmIns["out"].angleU[0].x - 95;
                    }
                    if (params.model == "ко") {
        ...
        function drawGRailing() {
            ...
            if (railingModel == "Самонесущее стекло") {
                ...
                var railingSection1;
                if ((railingSide_1 == "внешнее" || railingSide_1 == "две") && (stairAmt1 > 1 || stairAmt1 == 0)) {
                    railingSectionParams.topEnd = "площадка";
                    if (stairModel == "Г-образная с забегом") railingSectionParams.topEnd = "забег";
                    railingSectionParams.topConnection = outerHandrailConnection;
                    railingSectionParams.bottomConnection = false;
                ...
                if ((railingSide_1 == "внутреннее" || railingSide_1 == "две") && stairAmt1 > 2) {
                    railingSectionParams.topEnd = "нет";
                    railingSectionParams.bottomEnd = "нет";
                    railingSectionParams.platformLengthBottom = 0;
                    railingSectionParams.platformLengthTop = 0;
                ...
                if ((railingSide_3 === "внешнее" || railingSide_3 === "две") && ((stairAmt3 > 1 && platformTop != "площадка") || platformTop == "площадка")) {
                    railingSectionParams.topEnd = platformTop;
                    //railingSectionParams.bottomEnd = "площадка";
                    if (stairModel == "Г-образная с забегом") {
                ...
                if ((railingSide_3 === "внутреннее" || railingSide_3 === "две") && ((stairAmt3 > 1 && platformTop != "площадка") || platformTop == "площадка")) {
                    railingSectionParams.topEnd = platformTop;
                    railingSectionParams.bottomEnd = "нет";
                    railingSectionParams.platformLengthBottom = 0;
                    railingSectionParams.platformLengthTop = platformLength_3;
            ...
            if (railingModel == "Кованые балясины") {
                ...
                // внутреннее
                if ((railingSide_1 === "внутреннее" || railingSide_1 === "две") && stairAmt1 > 1) {
                ...
                // внешнее
                if ((railingSide_1 === "внешнее" || railingSide_1 === "две") && stairAmt1 > 0) {
                    railingSectionParams.lastMarsh = false;
                    railingSectionParams.railingSide = 'left';
    ...
    function drawPStairCase() {
        ...
        if (stringerTurn == "забег") {
            ...
            var turnParams = {
                ...
                turnFactor: turnFactor,
                dxfBasePoint: dxfBasePoint,
                extendTopTurnTread: 0,
                extendTopTurnTread6: 0,
                stepWidthLow: stepWidthLow, // глубина 3 забежной ступени
            }
            if (params.stairAmt3 === 0 && platformTop != "площадка") {
                turnParams.extendTopTurnTread6 = 40;
                if (topAnglePosition != "вертикальная рамка" && stringerSideOffset < 75) {
                    turnParams.extendTopTurnTread6 = 75;
                }
            }
            if (params.stairType == "стекло") turnParams.material = glassMaterial;
        ...
        function drawPStringers1() {
            ...
            if (params.model == "лт" && stairModel == "П-образная с забегом" && stairAmt1 === 0) {
                stringerParams1.botEnd = "winderBot0";
                stringerParams1.stairAmt = 0;
            }
            stringerParams1.key = "out";
        ...
        function drawPAngles1() {
            ...
            if (turnFactor > 0) { var key1 = "out"; var key2 = "in"; } else { var key1 = "in"; var key2 = "out"; }
            angleB.position.x = stringerParams1.elmIns[key1].angleB[0].x;
            angleB.position.y = stringerParams1.elmIns[key1].angleB[0].y;
            angleB.position.z = stringerThickness + stringerSideOffset;
            angleB.rotation.x = 0.0;
            angleB.rotation.y = 0.0;
            angleB.rotation.z = 0.0;
            ...
            angleB.position.x = stringerParams1.elmIns[key2].angleB[0].x + 100.0;
            angleB.position.y = stringerParams1.elmIns[key2].angleB[0].y;
            angleB.position.z = (params.M - stringerThickness) - stringerSideOffset;
            angleB.rotation.x = 0.0;
            angleB.rotation.y = Math.PI;
            angleB.rotation.z = 0.0;
        ...
        stringerParams3 = {
            ...
            elmIns: {},// точки размещения уголков
            railingModel: railingModel, //модель ограждения
            extendTopTurnTread: turnParams.extendTopTurnTread6,
        };
        ...
        function drawPStringers3() {
            ...
            if (params.model == "лт" && stairModel == "П-образная с забегом" && stairAmt3 === 0) {
                stringerParams3.botEnd = "winderTop0";
                stringerParams3.stairAmt = 1;
            }
            if (params.model == "ко" && stairAmt3 < 2 && !(platformTop == "площадка" && params.topPltRailing_3) && !(platformTop == "площадка" && stairAmt3 == 1) && turnFactor < 0) {
                stringerParams3.railingPresence = false;
            }
            ...
            if (platformTop == "площадка" && params.topPltRailing_4)
                stringerParams3.platformTopRailing = true;
            if (params.model == "ко" && stairAmt3 < 2 && !(platformTop == "площадка" && params.topPltRailing_4) && !(platformTop == "площадка" && stairAmt3 == 1) && turnFactor > 0) {
                stringerParams3.railingPresence = false;
            }
            ...
            if (platformTop != "площадка") {
                ...
                if (topAnglePosition == "вертикальная рамка") {
                    ...
                    if (params.model == "ко") {
                        ...
                        complexUnit.position.x = stairAmt3 * b3;
                        if (stairAmt3 == 0)
                            complexUnit.position.x = stringerParams3.elmIns["out"].angleU[0].x - 95 - (a3-b3-40);
                    }
                    stringerParams3.groupang.add(complexUnit);
                }
                /*верхний фланец (только для ЛТ)  */
        ...
        function drawPStringers2() {
            ...
            stringerParams2.topEndLength = stringerSideOffset - 15 + 60 + stringerThickness * 3 + 4.5 + 20;
            ...
            if (stairModel == "П-образная с забегом") {
                ...
                if (params.model == "ко")
                    stringer6.position.x -= stringerThickness * 2 + 1 - (a3-b3 - 40);
        ...
        function drawPAngles2() {
            if (stringerTurn == "забег") {
                ...
                angleB.castShadow = true;
                if (params.model == "ко")
                    angleB.position.x += a3 - b3 - 40;
                stringerParams2.groupang.add(angleB);

                if (stringerParams2.elmIns[key1].angleB[1]) {
                    var angleB = drawAngleSupport("У4-60х60х100");
                ...
                if (stringerParams2.elmIns[key2].angleB[1]) {
                    angleB = drawAngleSupport("У4-60х60х100");
            ...
            if (railingModel == "Ригели" || railingModel == "Стекло на стойках") {
                ...
                if (backRailing_2 === "есть" && stairModel == "П-образная с забегом") {
                    ...
                    if (model == "ко") {
                        ...
                        railingSection7.position.z -= (M - 20 + stringerSideOffset + stringerThickness) * turnFactor;
                    }
    ...
    function drawP3StairCase() {
        ...
        if (stringerTurn == "забег") {
            ...
            var turnParams = {
                ...
                dxfBasePoint: dxfBasePoint,
                extendTopTurnTread: 0,
                stepWidthLow: 40.0713, // глубина 3 забежной ступени
            }
            if (params.stairType == "стекло") turnParams.material = glassMaterial;
            ...
            if (turnModel == "лт стекло") {
                ...
                turnFramesParams = {
                    ...
                    treadsPosition: turnParams.treadsPosition,
                    turnSteps: turnParams.params,
                    stepWidthLow: 100, // глубина 3 забежной ступени
                };
        ...
        if (stringerTurn2 == "забег") {
            ...
            if (params.stairAmt3 === 0 && platformTop != "площадка") {
                turnParams.extendTopTurnTread = extendTopTurnTread;
                if (topAnglePosition != "вертикальная рамка" && stringerSideOffset < 75) {
                    turnParams.extendTopTurnTread = 75;
                }
            }
            if (params.stairType == "стекло") turnParams.material = glassMaterial;
        ...
        function drawP3Stringers1() {
            ...
            if (params.model == "лт" && stringerTurn == "забег" && stairAmt1 === 0) {
                stringerParams1.botEnd = "winderBot0";
                stringerParams1.stairAmt = 0;
            }
            stringerParams1.key = "out";
        ...
        function drawP3Stringers2() {
            ...
            if (params.model == "ко" && stringerTurn2 == "забег") {
                stringerParams2.topEndLength = turnFactor > 0 ? params.M + 25 - stringerSideOffset : stringerSideOffset - 15 + stringerThickness + 60 + 5 + 20;
            }
            stringerParams2.platformLength = params.M + 40 + 10;

            if (params.model == "ко" && stringerTurn == "забег" && stringerTurn2 == "забег" && stairAmt2 == 0) {
                stringerParams2.botEnd = "winder2";
                stringerParams2.divide = 0;
            }
            ...
            if (params.model == "ко" && stringerTurn == "забег" && stringerTurn2 == "забег" && stairAmt2 == 1 && turnFactor < 0) {
                stringerParams2.railingPresence = false;
            }
            ...
            if (params.model == "лт" && stringerTurn == "забег" && stairAmt2 === 0) {
                stringerParams2.botEnd = "winderTop0";
                stringerParams2.stairAmt = 1;
            }
            ...
            if (params.model == "ко" && stringerTurn == "забег" && stringerTurn2 == "забег" && stairAmt2 == 0) {
                stringer3.position.x -= M + ((stringerThickness * 2 - (a2 - b2 - 40)) * (turnFactor * 0.5 + 0.5));
                stringer4.position.x -= M + ((stringerThickness * 2 - (a2 - b2 - 40)) * (-turnFactor * 0.5 + 0.5));
            }
            ...
            if (stringerTurn2 == "площадка") {
                ...
                if (model == "лт") {
                    // задняя тетива площадки
                    p0 = {
                        x: b2 * stairAmt2 + tyrnLength2 + 5.0 + stringerThickness,
        ...
        function drawP3Angles2() {
            ...
            if (stringerTurn == "забег") {
                ...
                var dx1 = 0;
                if (params.model == "ко" && stringerTurn == "забег" && stringerTurn2 == "забег" && stairAmt2 == 0) {
                    dx = M + (stringerThickness * 2 * (turnFactor * 0.5 + 0.5));
                    dx1 = stringerThickness * 2;
                }

                //уголки соединения внешних тетив
                var angleB = drawAngleSupport("У4-60х60х100");
                angleB.position.x = stringerParams2.elmIns[key1].angleB[0].x - dx;
                angleB.position.y = stringerParams2.elmIns[key1].angleB[0].y;
                angleB.position.z = stringerThickness + stringerSideOffset;
                angleB.rotation.x = 0.0;
                angleB.rotation.y = 0.0;
                ...
                angleB.castShadow = true;
                if (params.model == "ко")
                    angleB.position.x += (a2 - b2 - 40) * (turnFactor * 0.5 + 0.5);
                stringerParams2.groupang.add(angleB);

                if (stringerParams2.elmIns[key1].angleB[1]) {
                    var angleB = drawAngleSupport("У4-60х60х100");
                    angleB.position.x = stringerParams2.elmIns[key1].angleB[1].x - dx;
                    angleB.position.y = stringerParams2.elmIns[key1].angleB[1].y;
                    angleB.position.z = stringerThickness + stringerSideOffset;
                    angleB.rotation.x = 0.0;
                    angleB.rotation.y = 0.0;
                ...
                //уголки соединения внутренних тетив
                angleB = drawAngleSupport("У4-60х60х100");
                angleB.position.x = stringerParams2.elmIns[key2].angleB[0].x - dx + dx1 * turnFactor;
                angleB.position.y = stringerParams2.elmIns[key2].angleB[0].y - 100;
                angleB.position.z = (M - stringerThickness) - stringerSideOffset;// ;
                angleB.rotation.x = 0.0;
                angleB.rotation.y = Math.PI;
                ...
                if (stringerParams2.elmIns[key2].angleB[1]) {
                    angleB = drawAngleSupport("У4-60х60х100");
                    angleB.position.x = stringerParams2.elmIns[key2].angleB[1].x - dx + dx1 * turnFactor;
                    angleB.position.y = stringerParams2.elmIns[key2].angleB[1].y - 100;
                    angleB.position.z = (M - stringerThickness) - stringerSideOffset;
                    angleB.rotation.x = 0.0;
                    angleB.rotation.y = Math.PI;
        ...
        function drawP3Stringers3() {
            ...
            if (params.model == "лт" && stringerTurn2 == "забег" && stairAmt3 === 0) {
                stringerParams3.botEnd = "winderTop0";
                stringerParams3.stairAmt = 1;
                if (stairAmt2 === 0) {
                    //stringerParams3.stairAmt1 = params.stairAmt2;
                }
            }
            if (params.model == "ко" && stringerTurn2 == "забег" && stairAmt3 < 2 && !(platformTop == "площадка" && params.topPltRailing_3) && !(platformTop == "площадка" && stairAmt3 == 1) && turnFactor < 0) {
                stringerParams3.railingPresence = false;
            }
            stringerParams3.key = turnFactor > 0 ? "out" : "in";
            if (params.model == "лт") drawStringerLt(stringerParams3, turnFramesParams, platformFramesParams1, platformFramesParams3, marshFramesParams3, turnParams);
            ...
            if (params.model == "ко" && stringerTurn2 == "забег" && stairAmt3 < 2 && !(platformTop == "площадка" && params.topPltRailing_4) && !(platformTop == "площадка" && stairAmt3 == 1) && turnFactor > 0) {
                stringerParams3.railingPresence = false;
            }
        ...
        function drawP3Angles3() {
            ...
            if (stringerTurn2 == "забег") {
                ...
                if (stringerParams3.elmIns[key1].angleB[1]) {
                    var angleB = drawAngleSupport("У4-60х60х100");
                    angleB.position.x = stringerParams3.elmIns[key1].angleB[1].x;
                    angleB.position.y = stringerParams3.elmIns[key1].angleB[1].y;
                    angleB.position.z = stringerThickness + stringerSideOffset;
        ...
        function drawP3Railing() {
            if (railingModel == "Ригели" || railingModel == "Стекло на стойках") {
                ...
                if (railingSide_2 == "внешнее" || railingSide_2 == "две") {
                    ...
                    if (turnType_1 == "забег" && turnType_2 == "забег" && params.stairAmt2 == 0) {
                        railingSectionParams.racks = [];
                        railingSectionParams.racks.push(stringerParams2.elmIns["out"].racks[0]);
                        railingSectionParams.racks.push(stringerParams2.elmIns["out"].racks[3]);
                        railingSectionParams.racks.push(stringerParams2.elmIns["out"].racks[1]);
                        railingSectionParams.racks.push(stringerParams2.elmIns["out"].racks[2]);
                    }
                    ...
                    if (params.model == "ко" && stringerTurn == "забег" && stringerTurn2 == "забег" && stairAmt2 == 0) {
                        railingSection1.position.z -= (M - (a2 - b2 - 40) + stringerThickness*2) * turnFactor;
                    }

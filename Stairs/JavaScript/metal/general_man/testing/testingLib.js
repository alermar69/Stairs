...
function setHiddenLayers(){
	...
	hidenLayers = ["forge", "topFloor", "floorBottom", "wall1", "wall2", "wall3", "wall4", "topRailing"];
	...
	if(params.calcType == "vint") hidenLayers.push("handrails", "stringers")

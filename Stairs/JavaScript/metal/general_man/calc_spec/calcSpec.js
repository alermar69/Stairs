...
function railingItemsAdd(par){
	...
	if(params.metalPaint_perila_bal == "как на лестнице") params.metalPaint_perila_bal = params.metalPaint;
...
function selfCarrierGlassItemsAdd(par){
	...
	if(totalGlassSectionAmt != 0){
		...
		if(par.unit == "staircase" || params.glassFix_bal == "рутели"){
			item = {
				id:  "rutel_m14",
				amt: rutelAmt,
...
console.log(params.treadMaterial)
